        ...
        <div class="max-w-xl mx-auto px-6">
            ...
            <form action="{{ route('professores.update', $professor) }}" method="post"
                ...
                <div>
                    ...
                    <input type="text" id="nome" name="nome" value="{{ old('nome', $professor->nome) }}"
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $professor->email) }}" {{-- Tipo mudado para 'email' --}}
                        class="w-full px-4 py-2.5 border border-gray-300 bg-slate-50/70 rounded-lg shadow-sm"
                        placeholder="{{ $professor->email }}" required>
                </div>
